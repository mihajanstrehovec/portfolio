        ...
        <div className="container mx-auto sm:pt-14 xl:max-w-[1280px]  " data-theme={colorTheme}>
            ...
            <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen} data-theme={colorTheme}>
                <div className="fixed inset-0 z-10" />
                 <Dialog.Panel className={`fixed inset-y-0 right-0 z-10 w-1/2 h-fit overflow-y-auto bg-background px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 border-l-4 border-b-4 border-primary`}>
