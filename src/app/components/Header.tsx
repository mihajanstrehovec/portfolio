                ...
                <div className="grid md:flex md:h-[166px] w-full gap-0 sm:gap-4">
                    ...
                    <div className={`hidden sm:block h-0 sm:h-10 md:h-full flex-1 md:border-2 border-primary relative bg-background`}>
                        <p className="p-4 invisible md:visible md:text-xs lg:text-sm xl:text-base">
                            Hello {"{reader.name}"} my name is <span className=" text-titles">Miha Jan Strehovec</span> I love working with computers, and I am passionate about <span className=" text-titles">web development</span>, <span className=" text-titles">user experience</span> and <span className=" text-titles">digitalization</span>. Through which I aim to make peoples lives easier. At 24, my journey has been diverse and forward-thinking, shaped by experiences that range from web development, QA and digital media leadership. In my free time I like to tackle personal projects that derive from my ideas or the ideas of my friends. Through them I attain new skills that I can then apply in my professional life.
                        </p>
